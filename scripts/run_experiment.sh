...
for SEED in $SEEDS; do
    ...
    echo "    python3 src/fl/client.py --server 192.168.1.10:8080 --data_dir $DATA_A --batch_size 8 --seed $SEED"
    echo ""
    echo "  Node B (192.168.1.7):"
    echo "    python3 src/fl/client.py --server 192.168.1.10:8080 --data_dir $DATA_B --batch_size 8 --seed $SEED"
    echo ""
    echo "  Node C (192.168.1.6):"
    echo "    python3 src/fl/client.py --server 192.168.1.10:8080 --data_dir $DATA_C --batch_size 8 --seed $SEED"
    echo ""
