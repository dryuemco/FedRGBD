...
for SEED in 42 123 456; do
    ...
    echo "  Node A (client):  python3 src/fl/client.py --server 192.168.1.10:8080 --data_dir data/processed/iid/node_a --batch_size 8 --seed ${SEED}"
    echo "  Node B (client):  python3 src/fl/client.py --server 192.168.1.10:8080 --data_dir data/processed/iid/node_b --batch_size 8 --seed ${SEED}"
    echo "  Node C (client):  python3 src/fl/client.py --server 192.168.1.10:8080 --data_dir data/processed/iid/node_c --batch_size 8 --seed ${SEED}"
...
for SEED in 42 123 456; do
    ...
    echo "  Node A (server):  python3 src/fl/server.py --strategy fedbn --rounds 3 --seed ${SEED} --output_dir ${DIR}"
    echo "  Node A (client):  python3 src/fl/client.py --server 192.168.1.10:8080 --data_dir data/processed/non_iid_label/node_a --batch_size 8 --seed ${SEED}"
    echo "  Node B (client):  python3 src/fl/client.py --server 192.168.1.10:8080 --data_dir data/processed/non_iid_label/node_b --batch_size 8 --seed ${SEED}"
    echo "  Node C (client):  python3 src/fl/client.py --server 192.168.1.10:8080 --data_dir data/processed/non_iid_label/node_c --batch_size 8 --seed ${SEED}"
